    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-header">
          ...
          <p className="auth-subtitle">Create your account and start listing</p>
        </div>
        {serverError && <div className="server-error-banner"><span>⚠️</span> {serverError}</div>}
        <form className="auth-form" onSubmit={handleSubmit} noValidate>
          <InputField id="username" label="Username" value={form.username} onChange={handleChange} placeholder="Choose a username" error={errors.username} required />
          ...
          <InputField id="password" label="Password" type="password" value={form.password} onChange={handleChange} placeholder="Min. 6 characters" error={errors.password} required />
          <InputField id="confirmPassword" label="Confirm Password" type="password" value={form.confirmPassword} onChange={handleChange} placeholder="Repeat your password" error={errors.confirmPassword} required />
