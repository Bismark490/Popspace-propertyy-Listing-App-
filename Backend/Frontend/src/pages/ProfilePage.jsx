...
const ProfilePage = () => {
  ...
  const handlePwChange = (e) => {
    ...
    setPwErrors({ ...pwErrors, [e.target.id]: '' });
    setPwMsg('');
    setPwError('');
  };
      ...
      <div className="profile-sections">
        ...
        <div className="profile-card">
          ...
          <form onSubmit={handleProfileSubmit} className="profile-form">
            <InputField id="username" label="Username" value={profile.username} onChange={handleProfileChange}
              placeholder="Your username" error={profileErrors.username} />
            <InputField id="phone" label="Phone Number" value={profile.phone} onChange={handleProfileChange}
              placeholder="+1 234 567 8900" error={profileErrors.phone} />
            <InputField id="avatar" label="Avatar URL" value={profile.avatar} onChange={handleProfileChange}
              placeholder="https://example.com/avatar.jpg" error={profileErrors.avatar} />
        ...
        <div className="profile-card">
          ...
          <form onSubmit={handlePasswordSubmit} className="profile-form">
            <InputField id="oldPassword" label="Current Password" type="password" value={pwForm.oldPassword}
              onChange={handlePwChange} placeholder="Your current password" error={pwErrors.oldPassword} required />
            <InputField id="newPassword" label="New Password" type="password" value={pwForm.newPassword}
              onChange={handlePwChange} placeholder="Min. 6 characters" error={pwErrors.newPassword} required />
            <InputField id="confirmNewPassword" label="Confirm New Password" type="password" value={pwForm.confirmNewPassword}
              onChange={handlePwChange} placeholder="Repeat new password" error={pwErrors.confirmNewPassword} required />
