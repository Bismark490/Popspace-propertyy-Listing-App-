...
const PropertyDetailPage = () => {
  ...
  const images = property.imageUrls?.length ? property.imageUrls : [defaultImage];
        ...
        <div className="detail-info">
          ...
          {isOwner && (
            <div className="detail-actions">
              <Link to={`/edit-property/${property._id}`} className="btn btn-secondary" id="edit-property-btn">
                ✏️ Edit Listing
              </Link>
